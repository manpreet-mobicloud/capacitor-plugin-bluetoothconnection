# capacitor-plugin-bledeviceconnection

This plugin is used to connect with ble-iot devices and communicate with them

## Install

```bash
npm install capacitor-plugin-bledeviceconnection
npx cap sync
```
